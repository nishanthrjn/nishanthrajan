...
Repository:
github.com/nishanthrjn/Agent-Nexus
...
Agent-Nexus placed 4th in the ANAC 2026 competition.

Public-safe description:
Agent-Nexus is an automated-negotiation agent and negotiation-strategy project developed
in Python using NegMAS for the ANAC 2026 automated-negotiation competition.

Critical attribution rules:
- The public project name is exactly Agent-Nexus.
...
- Do not state Bayesian opponent modelling, Pareto-optimal bidding, exact solo/team status,
  or IJCAI affiliation without separate verification.
